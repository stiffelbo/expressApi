...
module.exports =  {
  testimonials : [
    ...
    { id: 3, author: 'Armand Perez', text: 'Good!' },
    { id: 4, author: 'Diana May', text: 'I\'m happy!' },
    { id: 5, author: 'Joe Mitten', text: 'They really know stuff.' },
    { id: 6, author: 'Joseph Burke', text: 'Best you can find.' },  
  ],
  concerts : [
